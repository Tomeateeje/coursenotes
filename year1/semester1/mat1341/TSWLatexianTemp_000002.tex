...
\begin{document}
	...
	\normalsize
		...
		e.g. $(1,2,0),(2,4,)$ are collinear and span $\{ (1,2,0),(2,4,0) \}=\text{span}\{(1,2,0\}$\\\\
		\large{8.3}\\
		\normalsize
		3 vectors $\vec{u},\vec{v},\vec{w}\in\mathbb{R}^3$ are coplanar if there exists $a,b,r\in\mathbb{R}$ not all zero, such that $a\vec{u}+b\vec{v}+c\vec{w}=0$.\\
		...
		\begin{itemize}
			...
			\item $\left\{ \begin{bmatrix} {1}&{0}\\{0}&{0} \end{bmatrix},\begin{bmatrix} {0}&{1}\\{0}&{0} \end{bmatrix},\begin{bmatrix} {0}&{0}\\{1}&{0} \end{bmatrix},\begin{bmatrix} {0}&{0}\\{0}&{1} \end{bmatrix} \right\}\subseteq M_{22}(\marhbb{R})$\\
			Solve:
			$$
			...
			$$
			$a=0,b=0,c=0,d=0$.
			\item Is $\left\{ \begin{bmatrix} {1}&{0}\\{0}&{0} \end{bmatrix},\begin{bmatrix} {1}&{1}\\{1}&{0} \end{bmatrix},\begin{bmatrix} {0}&{4}\\{4}&{0} \end{bmatrix},\begin{bmatrix} {0}&{0}\\{0}&{3} \end{bmatrix} \right\}\subseteq M_{22}(\marhbb{R})$\\ linearly dependent or linerarly independent?\\
